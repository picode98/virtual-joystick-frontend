...
Public Class Form1
        ...
        If Not (connectionCancel) Then
            ...
            Else
                If initResult = -4 Or initResult = -6 Then
                    ...
                    If configureDialogResult = Windows.Forms.DialogResult.Yes Then
                        Try
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        For Each thisControl As System.Windows.Forms.Control In Me.Controls
            If thisControl.GetType() Is GetType(System.Windows.Forms.Button) Then
                Dim buttonControl As System.Windows.Forms.Button = CType(thisControl, System.Windows.Forms.Button)
    ...
    'Private Sub Joystick1_MouseMove(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
    ...
    'Private Sub Joystick1_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
    ...
    'Private Sub Joystick1_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
    '    'If e.Button = Windows.Forms.MouseButtons.Left Then
    ...
    Private Sub Trigger1Outline_MouseMove(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles ThrottleOutline.MouseMove
        If throttleMoving Then
    ...
    Private Sub Trigger1Outline_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles ThrottleOutline.MouseDown
        throttleMoving = True
        SetTriggerPosition(ThrottleOutline, ThrottleLevel, (CType(sender, Microsoft.VisualBasic.PowerPacks.RectangleShape).Size.Height - e.Y), currentControllerData.throttlePosition)
    End Sub

    Private Sub Trigger1Outline_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles ThrottleOutline.MouseUp
        throttleMoving = False
        'SetTriggerPosition(ThrottleOutline, ThrottleLevel, 0, currentControllerData.throttlePosition)
    End Sub

    Private Sub Button_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
        If sender.GetType() Is GetType(System.Windows.Forms.Button) Then
            Dim buttonControl As System.Windows.Forms.Button = CType(sender, System.Windows.Forms.Button)
            If Microsoft.VisualBasic.Left(buttonControl.Name, 1) = "B" Then
    ...
    Private Sub Button_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
        If sender.GetType() Is GetType(System.Windows.Forms.Button) Then
            Dim buttonControl As System.Windows.Forms.Button = CType(sender, System.Windows.Forms.Button)
            If Microsoft.VisualBasic.Left(buttonControl.Name, 1) = "B" Then
                Dim buttonNumStr As String = Microsoft.VisualBasic.Right(buttonControl.Name, buttonControl.Name.Length - 1)
                ...
                If e.Button = Windows.Forms.MouseButtons.Left And Not (buttonHolds(buttonNumInt)) Then
    ...
    'Private Sub POV_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
    ...
    'Private Sub POV_MouseMove(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
    '    If POVMoving Then
    '        If sender.GetType() Is GetType(Microsoft.VisualBasic.PowerPacks.RectangleShape) Then
    '            Dim POVPanelControl As Microsoft.VisualBasic.PowerPacks.RectangleShape = CType(sender, Microsoft.VisualBasic.PowerPacks.RectangleShape)
    ...
    'Private Sub POV_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs)
    '    If sender.GetType() Is GetType(Microsoft.VisualBasic.PowerPacks.RectangleShape) Then
    '        Dim POVPanelControl As Microsoft.VisualBasic.PowerPacks.RectangleShape = CType(sender, Microsoft.VisualBasic.PowerPacks.RectangleShape)
    ...
    Private Sub ConnectLabel_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles ConnectLabel.LinkClicked
        If Not (vJoyObject.getConnected()) Then
            connectDevice(True, True)
        End If
    End Sub
